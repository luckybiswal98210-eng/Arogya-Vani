...
const MULTILINGUAL_RESPONSES = {
    ...
    'mr': {
        ...
        "diabetes": "रक्तातील साखर नियमित तपासा, संतुलित आहार घ्या आणि डॉक्टरांच्या सल्ल्याचे पालन करा.",
        "hypertension": "मीठ कमी खा, नियमित व्यायाम करा, तणाव टाळा आणि डॉक्टरांचा सल्ला घ्या.",
        "fatigue": "पुरेशी झोप घ्या, संतुलित आहार घ्या आणि पाणी प्या.",
        "stress": "विश्रांती घ्या, ध्यान करा आणि संतुलित दिनचर्या ठेवा.",
    ...
    'ta': {
        ...
        "diabetes": "ரத்த சர்க்கரையை தவறாமல் சரிபார்க்கவும், சீரான உணவை உட்கொள்ளவும், மருத்துவர் ஆலோசனையை பின்பற்றவும்.",
        "hypertension": "உப்பை குறைக்கவும், உடற்பயிற்சி செய்யவும், மன அழுத்தத்தை தவிர்க்கவும்.",
        "fatigue": "போதிய உறக்கம், சத்தான உணவு மற்றும் தண்ணீர் தேவை.",
        "general_discomfort": "ஓய்வு எடுக்கவும், தண்ணீர் குடிக்கவும், அறிகுறி அதிகமானால் மருத்துவரை பார்க்கவும்."
    },
    'bn': {
        ...
        "stomach_ache": "হালকা খাবার খান, পানি পান করুন, ব্যথা বাড়লে ডাক্তার দেখান।",
        "diabetes": "রক্তের শর্করা নিয়মিত পরীক্ষা করুন, পুষ্টিকর খাবার খান এবং ডাক্তারের পরামর্শ মেনে চলুন।",
        "hypertension": "লবণ কম খান, নিয়মিত ব্যায়াম করুন এবং চিন্তামুক্ত থাকুন।",
        "fatigue": "পর্যাপ্ত ঘুম, পুষ্টিকর খাবার এবং প্রচুর পানি পান করুন।",
        "general_discomfort": "বিশ্রাম নিন, পানি পান করুন এবং সমস্যা বাড়লে ডাক্তারের কাছে যান।"
    },
    'te': {
        ...
        "diabetes": "రక్తంలో చక్కెరను క్రమం తప్పకుండా తనిఖీ చేయండి, ఆరోగ్యకరమైన ఆహారం తీసుకోండి.",
        "hypertension": "ఉప్పు వాడకం తగ్గించండి, క్రమం తప్పకుండా వ్యాయామం చేయండి.",
        "fatigue": "తగినంత నిద్ర, పోషకాహారం మరియు తగినంత నీరు అవసరం.",
        "general_discomfort": "విశ్రాంతి తీసుకోండి, నీరు తాగండి, సమస్య పెరిగితే డాక్టర్ను సంప్రదించండి."
    },
    'kn': {
        ...
        "stomach_ache": "ಹಗುರ ಆಹಾರ ಸೇವಿಸಿ, ನೀರು ಕುಡಿಯಿರಿ ಮತ್ತು ನೋವು ಹೆಚ್ಚಾದರೆ ವೈದ್ಯರನ್ನು ಸಂಪರ್ಕಿಸಿ.",
        "diabetes": "ರಕ್ತದ ಸಕ್ಕರೆಯನ್ನು ನಿಯಮಿತವಾಗಿ ಪರೀಕ್ಷಿಸಿ, ಸಮತೋಲಿತ ಆಹಾರ ಸೇವಿಸಿ.",
        "hypertension": "ಉಪ್ಪು ಕಡಿಮೆ ಮಾಡಿ, ನಿಯಮಿತ ವ್ಯಾಯಾಮ ಮಾಡಿ.",
        "fatigue": "ಸಾಕಷ್ಟು ನಿದ್ರೆ, ಪೌಷ್ಟಿಕ ಆಹಾರ ಮತ್ತು ನೀರು ಸೇವಿಸಿ.",
        "general_discomfort": "ವಿಶ್ರಾಂತಿ ಪಡೆದು ನೀರು ಕುಡಿಯಿರಿ, ತೊಂದರೆ ಹೆಚ್ಚಾದರೆ ವೈದ್ಯರನ್ನು ಭೇಟಿ ಮಾಡಿ."
    },
    'gu': {
        ...
        "stomach_ache": "હલકો ખોરાક લો, પાણી પીવો અને જો દુખાવો વધે તો ડૉક્ટરની સલાહ લો.",
        "diabetes": "બ્લડ શુગર નિયમિત ચેક કરો, સંતુલિત આહાર લો.",
        "hypertension": "મીઠું ઓછું ખાઓ, કસરત કરો અને તણાવથી બચો.",
        "fatigue": "પૂરતી ઊંઘ, પોષક આહાર અને પાણી પીવો.",
        "general_discomfort": "આરામ કરો, પાણી પીવો અને લક્ષણ વધે તો ડૉક્ટરનો સંપર્ક કરો."
    }
};
